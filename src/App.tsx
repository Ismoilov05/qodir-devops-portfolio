  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <section id="projects" className="container mx-auto px-6 pb-24">
        <p className="mb-2 text-center font-mono text-sm text-blue-500">
          $ ls ./projects
        </p>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          {projects.map((project) => (
            <a
              ...
              className="group flex flex-col rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 transition hover:border-blue-600 hover:bg-zinc-900"
            >
              <div className="flex items-start justify-between gap-4">
                ...
                <svg
                  viewBox="0 0 24 24"
                  className="mt-1 h-5 w-5 flex-shrink-0 fill-current text-zinc-600 transition group-hover:text-blue-400"
                  aria-hidden="true"
                >
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {project.tags.map((tag) => (
                  <span
                    key={tag}
                    className="rounded-full border border-zinc-700 px-3 py-1 font-mono text-xs text-zinc-400"
                  >
                    {tag}
                  </span>
                ))}
